      ...
      <scroller :on-infinite="infinite" ref="myscroller">
        <div class="yhj-item" v-for="(item,index) in list" :key="index">
          <div class="info">
            ...
            <div v-if="item.yh_num_status == 2">
              <span class="tit">数量：</span>
              <span>{{item.yh_num}}张</span>
            </div>
          </div>
          <div class="handle">
            <div class="h-item" @click="edit(item.id)" v-if="item.status == 0||item.status == 1||item.status == 4">
              <span class="h-icon">
      ...
      <div class="config" v-if="current_yhj">
        <div class="info">
          ...
          <div class="line">
            ...
            <span v-if="current_yhj.yh_num_status == 2">优惠券领完为止</span>
            <div v-else-if='current_yhj.yh_num_status == 1' class="day-input">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      sj_yhj() {
        if (this.current_yhj.yh_num_status == 1) {
          //   填写周期
          if (!this.day) {
